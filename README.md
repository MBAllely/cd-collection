...
_A more comprehensive CD collection app.  Written in php._

## Setup/Installation Requirements

* Clone this repository from [gitHub](https://github.com/MBAllely/cd-collection)
...
Copyright (c) 2016 _**Marika 'Space Pants' Allely and Jon Sweeney**_
